...
import { Loader2, Mail, User, AlertCircle, ArrowLeft } from "lucide-react"
import {
  InputOTP,
  InputOTPGroup,
  InputOTPSlot,
...
export function AuthModal({ isOpen, onClose }: AuthModalProps) {
  ...
  const sendOTP = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Check if user exists first to determine if we should ask for name
      ...
      success(`Verification code sent to ${email}. Please check your email and enter the code below.`)
      setStep("otp")
    } catch (error: any) {
      console.error("Error sending OTP:", error)
      setError(error.message || "An error occurred while sending the verification code")
    } finally {
      setLoading(false)
    }
  }
        ...
        <DialogHeader>
          ...
          <DialogDescription className="text-center">
            {step === "otp"
              ...
              : "Sign in or create your account to access premium luxury car rentals."
            }
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <form onSubmit={verifyOTP} className="space-y-6">
              <div className="space-y-2">
                <Label htmlFor="otp" className="text-center block">Enter the 6-digit code</Label>
